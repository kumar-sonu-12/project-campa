...
export const FrstHeading = ({ children }: HeadProp) => {
  return (
    <div className="text-[22px] sm:text-[26px] md:text-[32px] font-[900] leading-normal text-[#F3B814]">
      {children}
    </div>
  );
};
...
export const TitleHead = ({ children }: HeadProp) => {
  return (
    <div className="font-merienda max-w-[803px] z-10 text-[44px] sm:text-[55px] md:text-[66px] lg:text-[77px] xl:text-[88px] font-[900] leading-[60px] md:leading-[80px] lg:leading-[100px]  text-[#E7D2ff]">
      {children}
    </div>
  );
};
